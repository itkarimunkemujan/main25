...
const AnimatedNumber_001 = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center bg-[#f5f4f3] text-black">
      <div className="absolute start-1/2 top-22 grid -translate-x-1/2 content-start justify-items-center gap-6 text-center text-black rtl:translate-x-1/2">
        <span className="relative max-w-[12ch] text-xs leading-tight uppercase opacity-40 after:absolute after:start-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:from-[#f5f4f3] after:to-black after:content-['']">
...
export const AnimatedNumber_002 = () => {
  ...
  }, [inView, isVisible, springSubCount])
...
export const AnimatedNumber_003 = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center bg-[#f5f4f3] text-black">
      ...
      <div className="font-bebas-neue text-[20vw] tracking-tight">
        <motion.div ref={ref}>${formatNumber(displayNumber)}</motion.div>
      </div>
    </div>
  )
}
